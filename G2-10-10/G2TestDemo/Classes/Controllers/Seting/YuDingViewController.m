...
//    [self performSelector:@selector(readSetingInfo) withObject:nil afterDelay:1.0];
    NSString *str = [[NSUserDefaults standardUserDefaults] objectForKey:KYuJingShiJian];
    [self.yudingshijan setText:[NSString stringWithFormat:@"%@",str]];
    str = [[NSUserDefaults standardUserDefaults] objectForKey:KSuoDingShiJian];
    self.suodingshijian.text = [NSString stringWithFormat:@"%@",str];
    str = [[NSUserDefaults standardUserDefaults] objectForKey:KDaoQiBaoLiu];
