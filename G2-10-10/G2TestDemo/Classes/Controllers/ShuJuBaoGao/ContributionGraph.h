...
#pragma mark - ContributionGraphDelegate

@protocol ContributionGraphDataSource <NSObject>
...
@interface ContributionGraph : UIView
...
@property (nonatomic, weak) IBOutlet id<ContributionGraphDataSource> delegate;
