...
-(UITableViewCell *)processTableViewCell:(NSInteger)section row:(NSInteger)row
{
    ...
    Class clzz;
    if (bsContentObject!=nil) {
        NSArray *bs=bsContentObject;
        for (BSTableContentObject *cellId in bs) {
            if (cellId.cellIdentifier!=nil) {
                ID=cellId.cellIdentifier;
                clzz=cellId.cellClazz;
                break;
            }
        }
    ...
    if (clzz==nil) {
        clzz=[self cellIdentifierWithSection:section];
    }
    return [self processTableViewCell:clzz
                      bsContentObject:bsContentObject cellIdentifier:ID];
...
-(UITableViewCell *)processTableViewCell:(Class) cellClass
                         bsContentObject:(BSTableContentObject *)bsContentObject cellIdentifier:(NSString *)cellIdentifier{
