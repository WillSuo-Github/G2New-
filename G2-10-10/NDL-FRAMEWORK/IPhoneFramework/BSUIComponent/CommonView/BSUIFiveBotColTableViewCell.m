...
#import "BSUIFiveBotColTableViewCell.h"
#import "BSUIFrameworkHeader.h"
@interface BSUIFiveBotColTableViewCell()

@property (nonatomic,strong) NSArray *bsContentArray;

@end

@implementation BSUIFiveBotColTableViewCell
...
-(UITableViewCell *)viewCellWithBSContentObject:(NSArray *)bscArray{
    ...
    @try {
        ...
        for (tagIndex=1; tagIndex<bsContentArray.count; tagIndex++) {
            ...
            UILabel *cellLb=[[UILabel alloc ]initWithFrame:BSRectMake(lbRect.origin.x+(lbRowWith+lbRowHZ+6)*tagIndex,
                                                                      lbRect.origin.y ,
