...
@property (strong,nonatomic) NSString *asdateStr;
@property (strong,nonatomic) NSString *countStr;


@property (strong,nonatomic) NSString *shangHuHao; //商户号
@property (strong,nonatomic) NSString *zhongDuanHao; //终端号
@property (strong,nonatomic) NSString *jiaoYiShiJian; //交易时间
@property (strong,nonatomic) NSString *jiaoYiCanKaoHao; //交易参考号


@property (strong,nonatomic) NSString *qingSuanRiQi; //清算日期

@property (strong,nonatomic) NSString *jiaoYiTeZhengMa; //交易特征码
...
@synthesize asdateStr=_asdateStr;
...
- (void)_initSubViews
{
    ...
    self.zhongDuanHao = terCodeString;
    ...
    self.jiaoYiCanKaoHao = reCodeString;
    
    //交易金额
    //gTransacAmount[6]
    int transacAmount = BCDToInt(gTransacAmount, 6);
    self.countStr = [NSString stringWithFormat:@"%d.%.2d",transacAmount/100,transacAmount%100];
...
//    NSString *tranCodeString = [[NSString alloc] initWithData:mcCodeData encoding:NSUTF8StringEncoding];
    ...
    NSLog(@"date:%d",date);
    self.asdateStr =[NSString stringWithFormat:@"%04d/%02d/%02d %02d:%02d:%02d",[year intValue],date/100,date%100,time/10000,(time%10000)/100,time%100];
    
    self.jiaoYiShiJian = [NSString stringWithFormat:@"%04d%02d%02d",[year intValue],date/100,date%100];
    
    
   self.qingSuanRiQi = [NSString stringWithFormat:@"%02d%02d",date/100,date%100];
    
    NSString *temp = [self.qingSuanRiQi stringByAppendingString:self.jiaoYiCanKaoHao];
...
//    char *c2 = "56781234";
   ...
   self.jiaoYiTeZhengMa = [NSString stringWithCString:c3 encoding:NSASCIIStringEncoding];
    
    NSLog(@"_jiaoYiTeZhengMa:%@",self.jiaoYiTeZhengMa);
    
    
    self.ShuiYin.text = self.jiaoYiTeZhengMa;
    //[NSDate]
...
//        }
        ...
        switch (i) {
            ...
            case 14:
                ...
                break;
            case 15:
                label.text = [NSString stringWithFormat:@"%@",self.typeStr];
                break;
            case 16:
            ...
            case 17:
                ...
                break;
            case 18:
                label.text = [NSString stringWithFormat:@"%@", self.asdateStr];
            ...
            case 19:
                ...
                break;
            case 20:
                label.text = [NSString stringWithFormat:@"%@",self.countStr];
                break;
