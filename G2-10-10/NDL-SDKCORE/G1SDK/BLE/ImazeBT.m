...
- (BOOL)isLECapableHardware
{
    ...
    switch ([manager state])
    {
        ...
        case CBCentralManagerStatePoweredOff:
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:kBluetoothIsPoweredOff object:nil];
            self.isConnected = NO;
            //通知设备已断开
            deviceErrorFunc(3);
            break;
...
//    NSLog(@"advertisementData = %@",advertisementData);
    ...
    NSString *isNeedAutoConnect = [[NSUserDefaults standardUserDefaults] stringForKey:@"isNeedAutoConnect"];
    BOOL _isNeedConnect=[isNeedAutoConnect boolValue ];
    //BOOL isN;
    if (_isNeedConnect) {
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)aPeripheral error:(NSError *)error
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kBluetoothIsDisconnected object:nil];
...
- (void)connect:(CBPeripheral *)aper
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kConnectingDevice object:aper];
