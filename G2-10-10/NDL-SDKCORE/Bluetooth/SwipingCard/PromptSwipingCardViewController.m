...
//    UIButton *leftBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, -20, 30, 120)];
//    [leftBtn setImage:[UIImage imageNamed:@"hlk_fh"] forState:UIControlStateNormal];
    ...
    UIImageView *datubiaoImage = [[UIImageView alloc]initWithFrame:CGRectMake(-30, -10, 60, 43)];
...
-(void)recvMiniPosSDKStatus{
    ...
    if ([self.statusStr isEqualToString:@"获取卡号"]) {
        ...
        _cardNo = [NSMutableString stringWithUTF8String:MiniPosSDKGetCardNo()];
