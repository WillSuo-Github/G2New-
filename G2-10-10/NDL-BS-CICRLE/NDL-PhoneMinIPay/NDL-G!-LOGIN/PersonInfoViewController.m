...
- (void)loadHistory{
    ...
    self.password.text = [[NSUserDefaults standardUserDefaults] objectForKey:gerenMima];
    self.name.text = [[NSUserDefaults standardUserDefaults] objectForKey:gerenName];
    self.ID.text = [[NSUserDefaults standardUserDefaults] objectForKey:gerenID];
    self.certExpdate.text = [[NSUserDefaults standardUserDefaults] objectForKey:gerenShenfenzhengyouxiaoqi];
    
    _data1 = [[NSUserDefaults standardUserDefaults] objectForKey:gerenImage1];
    [self.IDPhotoFront setBackgroundImage:[UIImage imageWithData:_data1] forState:UIControlStateNormal];
    _data2 = [[NSUserDefaults standardUserDefaults] objectForKey:gerenImage2];
    [self.IDPhotoBack setBackgroundImage:[UIImage imageWithData:_data2] forState:UIControlStateNormal];
    _data3 = [[NSUserDefaults standardUserDefaults] objectForKey:gerenImage3];
    [self.IDPhotoAndPerson setBackgroundImage:[UIImage imageWithData:_data3] forState:UIControlStateNormal];

    _data10 = [[NSUserDefaults standardUserDefaults] objectForKey:gerenImage10];
...
//            [[NSFileManager defaultManager] createFileAtPath:self.imagePath10 contents:data attributes:nil];
            [KUserDefault setObject:data forKey:gerenImage10];
        }
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
     ...
     */
    if (textField.tag == 1) {
        [[NSUserDefaults standardUserDefaults] setObject:textField.text forKey:gerenMima];
    }else if (textField.tag == 3){
        
        [[NSUserDefaults standardUserDefaults] setObject:textField.text forKey:gerenName];
    }else if (textField.tag == 4){
        
        [[NSUserDefaults standardUserDefaults] setObject:textField.text forKey:gerenID];
    }else if (textField.tag == 5){
        
        [[NSUserDefaults standardUserDefaults] setObject:textField.text forKey:gerenShenfenzhengyouxiaoqi];
    }
