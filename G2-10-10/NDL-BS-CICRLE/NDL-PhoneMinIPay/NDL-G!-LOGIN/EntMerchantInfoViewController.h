...
@interface EntMerchantInfoViewController :G1BaseViewController<UITextFieldDelegate,WDPickViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>

@property (strong, nonatomic) IBOutlet UITextField *area;  //tag :1
@property (strong,nonatomic)  NSString *areaCode; //地区编码
@property (strong, nonatomic) IBOutlet UITextField *address;  //tag :2
