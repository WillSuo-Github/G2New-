 ...
 *标题名称
 */
@property (strong, nonatomic) NSString *colTitle;

/**
 *标题图标
 */
@property (strong, nonatomic) NSString *colImageName;

/**
 *NIB和故事板方式的标示Identifer,用于界面跳转
 */

@property (strong, nonatomic) NSString * vcClass;
/**
 *手工编码时需要提供的实现类ViewController,用于界面跳转
 */
@property (strong, nonatomic) Class     colClass;
 ...
 */
@property (strong,nonatomic) NSObject *neededMethodData;
 ...
 *在故事板跳转中，故事板的名称
 */
@property (strong,nonatomic) NSString *storybordName;

/**
 *表格的具体Cell在实现中所需的样式
 */
@property (strong ,nonatomic) NSMutableDictionary *styleDiction;
...
@property (strong, nonatomic) Class         cellClazz;
/**
 *此变量没有提供和其他变量一起初始化的方法，在运行时会根据列的容量设置
 */
