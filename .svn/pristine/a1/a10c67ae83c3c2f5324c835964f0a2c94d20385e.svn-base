...
-(void) viewDidDisappear:(BOOL)animated{
    NSLog(@"BSUICommonController viewDidDisappear,%@",self.description);
...
- (void)viewWillDisappear:(BOOL)animated{
    NSLog(@"BSUICommonController viewWillDisappear,%@",self.description);
...
-(void)layoutUI{
    ...
    /*添加下方工具栏*/
    _toolbar=[[UIToolbar alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, 44)];
