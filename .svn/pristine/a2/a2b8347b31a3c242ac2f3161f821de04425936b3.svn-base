...
- (IBAction)printAction:(UIButton *)sender {
    ...
    if(MiniPosSDKDeviceState()<0){
        ...
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"真功夫大兴店"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"台号：12         人数：2"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"单号：1511130066     收银员：01"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"时间：2015-11-14  13：10：03"],1);
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"---------------------------------------------"],1);
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"菜肴名称      数量       单价      金额    "],1);
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"---------------------------------------------"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"毛豆           1         8.00      8.00     "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"油焖大虾       1         8.00      8.00     "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"赠品：                                      "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"[青岛纯生]    1         0.00      0.00     "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"套餐：便民小吃  1       16.00     16.00     "],1);
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"---------------------------------------------"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"消费合计：   32元"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"优惠折扣：   2元"],1);
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"应付金额：   30元"],1);
        MiniPosSDKPrinter(2,50,[UIUtils UTF8_To_GB2312:@"---------------------------------------------"],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"欢迎再次光临真功夫大兴店           "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"定餐电话：010-66669999           "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"地址：北京市大兴区XX号           "],1);
        MiniPosSDKPrinter(0,30,[UIUtils UTF8_To_GB2312:@"技术支持By腾势股份           "],1);
