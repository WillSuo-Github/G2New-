...
- (void (^)(NSURLSessionDataTask *task, id responseObject))requestSuccessBlockWithModelRoute:(BSModelRoute *)modelRoute
    ...
    return ^(NSURLSessionDataTask *task, id responseObject) {
        ...
        NSObject *businessError = [responseObject valueForKeyPath:@"iosReturnJson"];
        ...
        //业务处理成功
        if ([[businessErrorModel statusCode] isEqualToString:@"0000"]||[[businessErrorModel statusCode] isEqualToString:@"200"]) {
            //处理ResponseBody
            NSObject *bussinessObject= [businessError
                                        valueForKeyPath:@"objectzJson"];
            //
