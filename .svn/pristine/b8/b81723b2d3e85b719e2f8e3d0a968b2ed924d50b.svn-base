...
- (void)viewDidLoad {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"NO" forKey:@"isNeedAutoConnect"];
...
- (IBAction)testBLEMatch:(id)sender {
...
- (void)_initSubViews
{
    ...
    _deviceView = [[UIView alloc] initWithFrame:CGRectMake(0, kHeight-200, kWidth, 200)];
    ...
    _deviceTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, kWidth, 160) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, kWidth-5, 44)];
...
{
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, kWidth-20, 40)];
    label.backgroundColor = [UIColor whiteColor];
